  ...
  return (
    <>
      <div className="w-full h-20 bg-gray-400  flex justify-end items-center z-10 sticky top-0 ">
        <div className="w-full flex  justify-center text-2xl font-bold text-white gap-y-6">
          Golu Choudhary
        </div>
        {showNavList ? (
          <MdMenuOpen
            className="w-12 h-12 bg-white mr-4 rounded-md"
      ...
      {showNavList ? (
        <div className="lg:hidden w-full h-screen bg-gray-500 flex flex-col pt-4 z-10 fixed overflow-hidden">
          <div className="w-full flex flex-col justify-center items-center text-xl font-bold gap-y-10  text-white ">
            ...
            <div>
              <a to="#tools" onClick={() => toggleNavList("#tools")}>
                Tools
              </a>
            </div>
            <div>
              <a to="/projects" onClick={() => toggleNavList("#projects")}>
                Projects
              </a>
            </div>
            <div>
              <a to="/contact" onClick={() => toggleNavList("#contact")}>
                Contact
              </a>
            </div>
            <div>
              ...
              <a
                ...
                onClick={() => {
                  window.open(
                    "https://drive.google.com/file/d/1eLUF4M5UNTXHDNxvMqHHlC4ruRr1HoNb/view",
                    "blank"
                  );
                }}
                target="_blank"
      ...
      <div className="hidden lg:block flex w-full bg-white-500 py-6 pr-2 border-none border-1 px-12  z-10 fixed top-0  justify-between overflow-hidden object-contian text-black bg-gray-400 ">
        <div className=" flex ">
          <div className="w-3/12 text-2xl font-bold text-white gap-12">
            Golu Choudhary
          </div>
