...
function Contact() {
  ...
  return (
    <>
      ...
      <div className="bg-gray-400 h-12 text-lg font-bold flex justify-center items-center text-black">
        Made By Golu choudhary
      </div>
    </>
  );
}
